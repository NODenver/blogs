...
<div class="data_list">
	...
	<div class="data_content" >
		<form action="${pageContext.request.contextPath}/student_saveStudent.action" method="post" onsubmit="return checkForm()">
		<table width="80%" align="center">
			<tr>
				<td><label>姓名：</label></td>
				<td><input type="text" id="name" name="stuname" value="${student.stuname }"/></td>
				<td>&nbsp;</td>
			...
			<tr>
				...
				<td>
					<input type="text" id="password" name="stupassword" value="${student.stupassword }"/>
				</td>
			</tr>
			<tr>
				<td>
					<input type="hidden" id="id" name="stuid" value="${student.stuid }"/><input type="submit" class="btn btn-primary" value="保存"/>
				</td>
				<td colspan="4">
