...
<div class="data_list">
	...
	<div class="data_content" >
		<form action="${pageContext.request.contextPath}/paper_savePaper.action" method="post" onsubmit="return checkForm()">
		<table width="40%" align="center">
			...
			<tr>
				<td>
					<input type="hidden" id="joinDate" name="joinDate" value="${paper.joinDate }"/>
