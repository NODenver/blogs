...
<body>
    ...
    <div id="js-modal-holder" class="modal-holder">
      ...
      <form action="${pageContext.request.contextPath }/student_login.action" method="post" onsubmit="return checkForm()" id="js-modal" class="modal">
        ...
        <p>管理员入口:<a href="index2.jsp">biu~</a></p>
        <div class="modal__description">欢迎登录葫芦娃在线考试系统, click × to close it</div>
        <div class="modal__section">
            <div class="input-with-label">
              <input id="name" name="stuid" value="${student.stuid }" type="text" class="input-with-label__input">
              <label for="name" class="input-with-label__label"> 准考证号
        ...
        <div class="modal__section">
            <div class="input-with-label">
              <input id="password"  name="stupassword" value="${student.stupassword }" type="password" class="input-with-label__input">
